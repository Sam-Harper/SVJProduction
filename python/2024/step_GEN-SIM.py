...
# with command line options: EmptyFragment_cff.py --era Run3_2024 --customise Configuration/DataProcessing/Utils.addMonitoring --beamspot DBrealistic --step GEN --geometry DB:Extended --conditions 140X_mcRun3_2024_realistic_v26 --datatier GEN --eventcontent RAWSIM --python_filename step_GEN-SIM.py --fileout file:EXO-RunIII2024Summer24GS-00250.root --number 100 --no_exec --mc
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('EmptyFragment_cff.py nevts:100'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:EXO-RunIII2024Summer24GS-00250.root'),
